...
test_vpkuwus_3:
  # destination aliases vA
  # {1, 65536, 2, 65535}
  #_ REGISTER_IN v3 [00000001, 00010000, 00000002, 0000FFFF]
  # {3, 4, 131072, 5}
  #_ REGISTER_IN v4 [00000003, 00000004, 00020000, 00000005]
  vpkuwus v3, v3, v4
  blr
  # {1, 65535, 2, 65535, 3, 4, 65535, 5}
  #_ REGISTER_OUT v3 [0001FFFF, 0002FFFF, 00030004, FFFF0005]
  #_ REGISTER_OUT v4 [00000003, 00000004, 00020000, 00000005]

test_vpkuwus_4:
  # destination aliases vB
  #_ REGISTER_IN v3 [00000001, 00010000, 00000002, 0000FFFF]
  #_ REGISTER_IN v4 [00000003, 00000004, 00020000, 00000005]
  vpkuwus v4, v3, v4
  blr
  #_ REGISTER_OUT v3 [00000001, 00010000, 00000002, 0000FFFF]
  #_ REGISTER_OUT v4 [0001FFFF, 0002FFFF, 00030004, FFFF0005]
